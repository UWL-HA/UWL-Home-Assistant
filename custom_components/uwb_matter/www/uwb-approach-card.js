  ...
  render() {
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        .metrics{display:grid;grid-template-columns:repeat(auto-fit,minmax(110px,1fr));gap:1px;background:var(--divider-color);border:1px solid var(--divider-color);border-radius:10px;overflow:hidden}.metric{border:0;text-align:left;background:var(--card-background-color);border-radius:0;padding:10px 11px;color:var(--primary-text-color);min-width:0;cursor:pointer}
